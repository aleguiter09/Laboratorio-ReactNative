...
export const StoreProvider = ({children}) => {
    ...
    const [compradores, setCompradores] = useState([
      {nombre: "Alejandro Guiter", email: "aleguiter@gmail.com", id: Math.random().toString(10)},
      {nombre: "Exequiel Sanchez", email: "exesanchez@gmail.com", id: Math.random().toString(10)},
      {nombre: "Fiorella Triverio", email: "fiotriverio@gmail.com", id: Math.random().toString(10)},
    ]);
